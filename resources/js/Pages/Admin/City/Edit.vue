<template>
    ...
    <AuthenticatedLayout>
        <template #header> Редагувати інформацію міста</template>

        <div class="md:ml-64 flex flex-column w-full ">
            <div class="w-full py-12 mx-auto sm:px-6 lg:px-8">
...
<script>
    ...
    export default {
        ...
        methods: {
            update() {
                Inertia.patch(route('city.update', this.city.id), this.form)
            }
        },
